 ...
 */
define(['taoQtiTest/runner/branchRule/branchRuleMapper'], function(branchRuleMapper) {
    'use strict';
    ...
    QUnit.cases
        ...
        .test('it returns the proper branch rule component', function(data, assert) {
            ...
            assert.equal(
                typeof branchRuleMapper(data.branchRuleName, mockBranchRuleDefinition)['validate'],
                'function'
            );
        });
