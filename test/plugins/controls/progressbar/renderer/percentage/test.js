 ...
 */
define(['jquery', 'taoQtiTest/runner/plugins/controls/progressbar/renderer/percentage'], function(
    $,
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.equal(
            typeof percentageRendererFactory,
            'function',
            'The percentageRendererFactory module exposes a function'
        );
        assert.equal(
            typeof percentageRendererFactory(),
            'object',
            'The percentageRendererFactory factory produces an object'
        );
        assert.notStrictEqual(
            percentageRendererFactory(),
            percentageRendererFactory(),
            'The percentageRendererFactory factory provides a different object on each call'
        );
    });
