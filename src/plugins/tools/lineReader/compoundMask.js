 ...
 */
export default function compoundMaskFactory(options, dimensions, position) {
    var compoundMask,
        allParts = {},
        innerDrag,
        closer,
        ...
        var overlay,
            overlayAPI = {
                transformOverlay: function transformOverlay() {
                    ...
                    this.setSize(dimensions.outerWidth, dimensions.outerHeight).moveTo(
                        position.outerX,
                        position.outerY
                    );
                ...
                restoreOverlay: function restoreOverlay() {
                    ...
                    if (this.is('transformed')) {
                        this.setSize(this._sizeBackup.width, this._sizeBackup.height).moveTo(
                            this._posBackup.x,
                            this._posBackup.y
                        );
                ...
                rect = {
                    ...
                    height:
                        ...
                        (dimensions.innerHeight +
                            constrains.minTopHeight +
                            constrains.minBottomHeight -
                            options.innerDragHeight)
                };
    ...
    function applyTransformsToInnerDrag() {
        if (innerDrag) {
            innerDrag
                ...
                .moveTo(position.innerX + 10, position.innerY + dimensions.innerHeight + options.resizeHandleSize);
        }
    }
    ...
    function createCompoundMask() {
        ...
        createPart({
            ...
            place: function place() {
                this.moveTo(position.innerX + dimensions.innerWidth, position.outerY).setSize(
            ...
            placeOverlay: function placeOverlay(overlay) {
                ...
                overlay
                    ...
                    .setSize(size.width - options.resizeHandleSize, size.height - options.resizeHandleSize * 2);
            },
        ...
        createPart({
            ...
            place: function place() {
                this.moveTo(position.innerX + dimensions.innerWidth, position.innerY + dimensions.innerHeight).setSize(
                    dimensions.rightWidth,
        ...
        createPart({
            ...
            place: function place() {
                this.moveTo(position.outerX, position.innerY + dimensions.innerHeight).setSize(
