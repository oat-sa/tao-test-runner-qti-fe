...
define([
    ...
    'tpl!taoQtiTestSource/runner/plugins/tools/magnifier/magnifierPanel'
    ...
    QUnit.test('DOM', function(assert) {
        ...
        component
            ...
            .on('render', function() {
                ...
                assert.equal(
                    $('[data-control="zoomOut"]', $element).length,
                    1,
                    'The zoomOut controls element is there'
                );
                assert.equal($('.close', $element).length, 1, 'The close controls element is there');
                assert.equal(
                    $('.close [data-control="closeMagnifier"]', $element).length,
                    1,
                    'The closeMagnifier controls element is there'
                );
