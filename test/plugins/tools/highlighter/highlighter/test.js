 ...
 */
define(['jquery', 'taoQtiTest/runner/plugins/tools/highlighter/highlighter'], function($, highlighterFactory) {
    'use strict';
    ...
    QUnit.test('Toggle highlight mode on/off', function(assert) {
        ...
        assert.equal(
            ...
            'This text is available for your highlighting needs',
        ...
        assert.equal(
            highlightedElement.textContent.trim(),
            'This text is available for your highlighting needs',
            'correct content has been highlighted'
        );
