 ...
 *
 * @see taoQtiTest/views/js/test/runner/proxy/qtiServiceProxy/test.js
...
define([
    ...
    QUnit.test('module', function(assert) {
        assert.expect(6);
        assert.equal(typeof qtiServiceProxy, 'object', 'The offlineProxy module exposes an object');
        ...
        assert.equal(typeof proxyFactory('qtiServiceProxy'), 'object', 'The proxyFactory factory has registered the offlineProxy definition and produces an instance');
        assert.notStrictEqual(proxyFactory('qtiServiceProxy'), proxyFactory('qtiServiceProxy'), 'The proxyFactory factory provides a different instance of offlineProxy on each call');
    });
    ...
    QUnit
        ...
        .test('proxy API ', function(data, assert) {
            assert.expect(1);
            assert.equal(typeof qtiServiceProxy[data.title], 'function', `The offlineProxy definition exposes a "${  data.title  }" function`);
        });
    ...
    QUnit
        ...
        .test('offlineProxy.init ', function(caseData, assert) {
    ...
    QUnit.test('offlineProxy.destroy', function(assert) {
        var ready = assert.async();
        var initConfig = {
            testDefinition: 'http://tao.dev/mockTestDefinition#123',
            testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.getTestData ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.getTestContext ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.getTestMap ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.sendVariables ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.callTestAction ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
            ...
            proxy.init().then(function() {
                ...
                proxy.on('callTestAction', function(promise, action, params) {
                    ...
                    assert.deepEqual(Object.keys(params), Object.keys(caseData.params));
                    // Remove the actionId from testing, as the value of it is autogenerated
                    delete params.actionId;
                    delete caseData.params.actionId;
    ...
    QUnit
        ...
        .test('offlineProxy.getItem ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.submitItem ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.callItemAction ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit
        ...
        .test('offlineProxy.telemetry ', function(caseData, assert) {
            var ready = assert.async();
            var initConfig = {
                testDefinition: 'http://tao.dev/mockTestDefinition#123',
                testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit.test('offlineProxy.getCommunicator #enabled', function(assert) {
        var ready = assert.async();
        var initConfig = {
            testDefinition: 'http://tao.dev/mockTestDefinition#123',
            testCompilation: 'http://tao.dev/mockTestCompilation#123',
    ...
    QUnit.test('offlineProxy.getCommunicator #disabled', function(assert) {
        var ready = assert.async();
        var initConfig = {
            testDefinition: 'http://tao.dev/mockTestDefinition#123',
            testCompilation: 'http://tao.dev/mockTestCompilation#123',
