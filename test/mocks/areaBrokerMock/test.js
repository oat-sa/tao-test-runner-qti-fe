 ...
 */
define(['lodash', 'taoQtiTest/test/runner/mocks/areaBrokerMock'], function(_, areaBrokerMock) {
    'use strict';
    ...
    QUnit.test('factory', function(assert) {
        ...
        assert.equal(
            broker.getContainer().children().length,
            areas.length,
        ...
        assert.notEqual(
            ...
            areaBrokerMock()
                .getContainer()
                .get(0),
            'The factory creates a new container for each instance'
        );
    });
