 ...
 */
define(['taoQtiTest/runner/branchRule/types/and', 'taoQtiTest/test/runner/branchRule/mockBranchRuleMapper'], function(
    ...
    QUnit.cases
        .init([
            ...
            {
                branchRules: [
                    mockBranchRuleMapper.MOCK_TRUE_BRANCH_RULE,
                    mockBranchRuleMapper.MOCK_TRUE_BRANCH_RULE,
                    mockBranchRuleMapper.MOCK_TRUE_BRANCH_RULE
                ]
            }
        ...
        .test('it returns true if all expressions are true', function(data, assert) {
            ...
            andBranchRuleFactory(branchRuleDefinition, null, null, mockBranchRuleMapper.getMockBranchRuleMapper)
                .validate()
        ...
        .init([
            ...
            { branchRules: [mockBranchRuleMapper.MOCK_FALSE_BRANCH_RULE, mockBranchRuleMapper.MOCK_TRUE_BRANCH_RULE] },
            {
                branchRules: [
                    mockBranchRuleMapper.MOCK_TRUE_BRANCH_RULE,
                    mockBranchRuleMapper.MOCK_TRUE_BRANCH_RULE,
                    mockBranchRuleMapper.MOCK_FALSE_BRANCH_RULE
                ]
            }
        ])
