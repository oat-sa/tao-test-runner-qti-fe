 ...
 */
define(['lodash', 'util/url', 'taoQtiTest/runner/config/qtiServiceConfig'], function(_, urlUtil, qtiServiceConfig) {
    'use strict';
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.notStrictEqual(
            qtiServiceConfig(config),
            qtiServiceConfig(config),
            'The qtiServiceConfig factory provides a different instance on each call'
        );
    });
    ...
    QUnit.cases
        ...
        .test('proxy API ', function(data, assert) {
            ...
            assert.equal(
                ...
                'function',
                `The qtiServiceConfig instances expose a "${data.title}" function`
            );
        });
    ...
    QUnit.test('qtiServiceConfig factory', function(assert) {
        ...
        assert.ok(
            true,
            'The qtiServiceConfig() factory must not throw an exception when all the required config entries are provided'
        );
    ...
    QUnit.test('qtiServiceConfig.getTestDefinition', function(assert) {
        ...
        assert.equal(
            instance.getTestDefinition(),
            expectedTestDefinition,
            'The qtiServiceConfig.getTestDefinition() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getTestCompilation', function(assert) {
        ...
        assert.equal(
            instance.getTestCompilation(),
            expectedTestCompilation,
            'The qtiServiceConfig.getTestCompilation() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getServiceCallId', function(assert) {
        ...
        assert.equal(
            instance.getServiceCallId(),
            expectedServiceCallId,
            'The qtiServiceConfig.getServiceCallId() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getServiceController', function(assert) {
        ...
        assert.notEqual(
            instance.getServiceController(),
            expectedServiceController,
            'The qtiServiceConfig.getServiceController() method must return the default value'
        );
        assert.ok(
            !!instance.getServiceController(),
            'The qtiServiceConfig.getServiceController() method must not return a null value'
        );
        ...
        assert.equal(
            instance.getServiceController(),
            expectedServiceController,
            'The qtiServiceConfig.getServiceController() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getServiceExtension', function(assert) {
        ...
        assert.notEqual(
            instance.getServiceExtension(),
            expectedServiceExtension,
            'The qtiServiceConfig.getServiceExtension() method must return the default value'
        );
        assert.ok(
            !!instance.getServiceExtension(),
            'The qtiServiceConfig.getServiceExtension() method must not return a null value'
        );
        ...
        assert.equal(
            instance.getServiceExtension(),
            expectedServiceExtension,
            'The qtiServiceConfig.getServiceExtension() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getTestActionUrl', function(assert) {
        ...
        assert.equal(
            instance.getTestActionUrl(actionName),
            expectedUrl,
            'The qtiServiceConfig.getTestActionUrl() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getItemActionUrl', function(assert) {
        ...
        assert.equal(
            instance.getItemActionUrl(itemUri, actionName),
            expectedUrl,
            'The qtiServiceConfig.getItemActionUrl() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getTelemetryUrl', function(assert) {
        ...
        assert.equal(
            instance.getTelemetryUrl(itemUri, signalName),
            expectedUrl,
            'The qtiServiceConfig.getTelemetryUrl() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getTimeout', function(assert) {
        ...
        assert.equal(
            typeof instance.getTimeout(),
            'undefined',
            'The qtiServiceConfig.getTimeout() method must return an undefined value if no timeout has been set'
        );
        ...
        assert.equal(
            instance.getTimeout(),
            10000,
            'The qtiServiceConfig.getTimeout() method has returned the expected value'
        );
    });
    ...
    QUnit.test('qtiServiceConfig.getCommunicationConfig', function(assert) {
        ...
        assert.deepEqual(
            ...
            expected,
            'The qtiServiceConfig.getCommunicationConfig() method has returned the default values'
        );
        ...
        assert.deepEqual(
            instance.getCommunicationConfig(),
            expected,
            'The qtiServiceConfig.getCommunicationConfig() method has returned the expected values'
        );
