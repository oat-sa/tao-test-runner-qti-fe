 ...
 */
define(['taoQtiTest/runner/services/responseStore'], function(responseStoreFactory) {
    'use strict';
    ...
    QUnit.module('responseStore', {
        beforeEach: function(assert) {
            ...
            Promise.all([responseStore.clearResponses(), responseStore.clearCorrectResponses()]).then(function() {
                done();
            });
        }
    });
