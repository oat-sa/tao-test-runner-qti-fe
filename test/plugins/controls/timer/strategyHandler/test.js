 ...
 */
define(['core/eventifier', 'taoQtiTest/runner/plugins/controls/timer/strategy/strategyHandler'], function(
    eventifier,
    strategyHandler
) {
    'use strict';
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.equal(
            typeof strategyHandler(testRunnerMock),
            'object',
            'The strategyHandler factory produces an object'
        );
        assert.notStrictEqual(
            strategyHandler(testRunnerMock),
            strategyHandler(testRunnerMock),
            'The strategyHandler factory provides a different object on each call'
        );
    });
    ...
    QUnit.cases
        ...
        .test('Instance API ', function(data, assert) {
            ...
            assert.equal(
                ...
                'function',
                `The strategyHandler exposes the method "${  data.title}`
            );
        });
    ...
    QUnit.test('factory', function(assert) {
        ...
        assert.throws(
            ...
            TypeError,
            'No valid test runner given throws'
        );
        assert.throws(
            function() {
                strategyHandler({
