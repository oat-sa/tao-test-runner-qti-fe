...
], function($, testRunnerFactory, providerMock, alertMessage, qtiItemRunner, itemData) {
    'use strict';
    ...
    QUnit.test('init', function(assert) {
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function() {
                ...
                const feedback = alertMessage(testRunner, testRunner.getAreaBroker());
