...
import extraTimeStrategy from 'taoQtiTest/runner/plugins/controls/timer/strategy/enforcedStay';
import enforcedStayStrategy from 'taoQtiTest/runner/plugins/controls/timer/strategy/extraTime';
import guidedNavigationStrategy from 'taoQtiTest/runner/plugins/controls/timer/strategy/guidedNavigation';
import timeoutStrategy from 'taoQtiTest/runner/plugins/controls/timer/strategy/timeout';
import warnSectionLeavingStrategy from 'taoQtiTest/runner/plugins/controls/timer/strategy/warnSectionLeaving';
 ...
 */
export default function getStrategyHandler(testRunner, strategies) {
    var strategyHandler;
