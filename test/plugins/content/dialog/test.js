...
define([
...
], function(_, async, dialogAlert, dialogConfirm, runnerFactory, providerMock, dialogFactory) {
    'use strict';
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.notStrictEqual(
            dialogFactory(runner),
            dialogFactory(runner),
            'The dialogFactory factory provides a different instance on each call'
        );
    });
    ...
    QUnit.cases.init(pluginApi).test('plugin API ', function(data, assert) {
        ...
        assert.equal(
            ...
            'function',
            `The dialogFactory instances expose a "${data.name}" function`
        );
    });
